...
client.on("message", message => {
    ...
    if (message.content == "!historie") {
		...
		if (historie == 8) {
	    	message.channel.send("@everyone Du er lige logget ind i serveren. en af dine teammates taler kun tysk. vælger du at sige den magiske remse: sie bist bøsse und knalden mit dem tyr eller siger du heil Hitler?");
		}
	
		if (historie == 9) {
	    	message.channel.send("@everyone du er i comp med Alex. han køber to flash-bangs. Du vælger at gå palace og lige da du peaker misser Alex sin flash. Vil du vælge at skyde ham eller skyde ham?");
		}		
   }
